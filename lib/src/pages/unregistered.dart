...
class Unregistered extends StatefulWidget {
  @override
  _Unregistered_State createState() => _Unregistered_State();
}
...
class _Unregistered_State extends State<Unregistered> {
                                                              ...
                                                              children: [
                                                                Container(
                                                                  width: MediaQuery.of(
                                                                      ...
                                                                      0.5,
                                                                  child: Text(
                                                                    '2 days remain before you lose all your rewards. Please complete registration to store your rewards permanently.',
                                                                    style: desc,
                                                                    textAlign:
                                                                        TextAlign
                                                                            .center,
