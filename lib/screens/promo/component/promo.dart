...
class _Promo_State extends State<Promo> {
  PromoController promoController = Get.find<PromoController>();
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        promoController.brandList.isEmpty
                            ? ListView(
                                shrinkWrap: true,
                                children: [
                                  SizedBox(
                            ...
                            : Expanded(
                                child: ListView.separated(
                                  ...
                                  itemCount: promoController.brandList.length,
                                  separatorBuilder: (context, index) =>
                                      const Divider(
                                          color: Color(0XFFD9D9D9),
                                          thickness: 1),
                                  itemBuilder: (context, index) {
                                    RewardsPointModel data =
                                        promoController.brandList[index];
                                    return GestureDetector(
                                      onTap: () {
                                        promoController.getMerchantDetails(
                                            data.merchantId!);
          ...
          child: Obx(() => promoController.isLoadingMerchant.value
              ...
              : Column(
                  ...
                  children: [
                    ...
                    Text(
                        promoController
                                    .merchantDeatails.value.userInformation ==
                                null
                            ? ""
                          ...
                          child: Column(
                            children: [
                              SmoothStarRating(
                                ...
                                starCount: 5,
                                rating: promoController
                                        .merchantDeatails.value.averageRating ??
                                    0,
                                size: 30.0,
                                color: Colors.black,
                        ...
                        SizedBox(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                  promoController
                                          .merchantDeatails.value.description ??
                                      "",
                                  style: dialogTextSm,
